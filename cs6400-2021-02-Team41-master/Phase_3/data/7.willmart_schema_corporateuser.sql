...
CREATE TABLE `corporateuser` (
  `corpUID` varchar(20) NOT NULL,
  PRIMARY KEY (`corpUID`),
  CONSTRAINT `fk_CorporateUser_uID_User_uID` FOREIGN KEY (`corpUID`) REFERENCES `user` (`uID`)
...
LOCK TABLES `corporateuser` WRITE;
/*!40000 ALTER TABLE `corporateuser` DISABLE KEYS */;
INSERT INTO `corporateuser` VALUES ('user1001');
/*!40000 ALTER TABLE `corporateuser` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-07-18 22:20:58
